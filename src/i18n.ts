...
const en: Dict = {
  ...
  "export.hint": "Printable PDFs you can save or share.",
  "export.planPrint": "Floor plan: print with Ctrl/⌘+P (one hall per page).",
  "export.guestList": "Guest list",
  "export.guestListHint": "By table + alphabetical",
  "export.escortCards": "Escort cards",
  "export.escortHint": "Name → table, for the entrance",
...
const ru: Dict = {
  ...
  "export.title": "Экспорт в PDF",
  "export.hint": "PDF для печати — сохраните или поделитесь.",
  "export.planPrint": "План зала: печать по Ctrl/⌘+P (по залу на лист).",
  "export.guestList": "Список гостей",
  "export.guestListHint": "По столам + по алфавиту",
  "export.escortCards": "Рассадочные карточки",
  "export.escortHint": "Имя → стол, для входа",
