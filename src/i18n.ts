...
const en: Dict = {
  ...
  "pwa.refresh": "Force update",
  "pwa.refreshHint": "Stuck on an old version? Clear the cache and reload the latest.",
  "about.title": "About",
  "about.description": "A browser tool for arranging tables and seating guests at weddings and events.",
  "about.version": "Version",
  "about.build": "Build",
  "about.author": "Author",
  "about.authorName": "Ilia “angu1ss” Antonov",
...
const ru: Dict = {
  ...
  "pwa.refresh": "Обновить принудительно",
  "pwa.refreshHint": "Залипла старая версия? Очистить кэш и загрузить свежую.",
  "about.title": "О приложении",
  "about.description": "Браузерный инструмент для расстановки столов и рассадки гостей на свадьбах и мероприятиях.",
  "about.version": "Версия",
  "about.build": "Сборка",
  "about.author": "Автор",
  "about.authorName": "Илья «angu1ss» Антонов",
